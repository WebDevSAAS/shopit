...
// Sign-Up Validation
const pswdValid = document.querySelector("#pass");
const re_pswdValid = document.querySelector("#re_pass");
const nameValid = document.querySelector("#name");
const emailValid = document.querySelector("#email");
const signBtn = document.querySelector(".sig-btn");

const nameEmp = document.querySelector(".sign--name");
const emailEmp = document.querySelector(".sign--email");
const paswdEmp = document.querySelector(".sign--password");
const repaswdEmp = document.querySelector(".sign--repassword");
let alright = 1;

function removeClass(divInput, divError) {
  divError.classList.remove("hidden");
  divError.style.marginLeft = "0.2rem";
  divInput.style.marginBottom = "1px";
  alright = 0;
}

function addClass(divInput, divError) {
  divInput.style.marginBottom = "11px";
